...
Its current version is: v1.0.0-10
 ...
 * If you are a Windows user, just figure out where are your settings folders. (the folder `Sublime Text 3\` below contain all your current settings)
```
