# Copy Filepath With Line Numbers Configurations 

This folder has the purpose to disable the default Copy Filepath With Line Numbers package Context Menus.
